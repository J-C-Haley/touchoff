...
'''
        ...
        # ATTEMPTING PILZ
        # self.r.move(Lin(goal=Pose(position=Point(0, 0, 0.01)), planning_group='arm', reference_frame="prbt_tcp", vel_scale=0.2))
        # self.r.move(Lin(goal=Pose(position=Point(0, 0, 0.01)), planning_group='arm', reference_frame="robot_tcp", vel_scale=0.2))
        # reference_frame="robot_tcp"
        # target_link='robot_tcp',base='world'
